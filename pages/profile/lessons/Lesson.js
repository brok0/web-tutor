...
export default function Lesson({ lesson }) {
  ...
  return (
    <div onClick={toggleDetailsModal} className="container w-11/12 rounded border-purple-300 border-4 m-2 p-2 cursor-pointer hover:bg-gray-200 md:flex md:justify-between">
      <div>
        <h2>
