...
export default function DateTimePickerModal({ onClose, lesson, price }) {
				...
				<div className="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all md:w-auto sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
					<div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
						<div className="mt-3 text-center sm:mt-0  sm:text-left h-96 w-full">
							<h3
								className="text-lg leading-6 font-medium text-gray-900 border-b-2 mb-2"
								id="modal-title"
							>
								Buy Lesson {lesson} for {price}$
							</h3>
							<div className="m-1">
								{!dateConfirmed ? (
									<div>
									...
									// TODO: Add options chip like : today,tommorow, ...
									<div className="">
