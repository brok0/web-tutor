...
export default function SearchBar({ updateTutors }) {
  ...
  const handleSearch = () => {
    ...
    let priceRange = document.getElementById("price-dropdown").textContent.replace(/\$/g, "");

    priceRange = priceRange.split("-");

    const selectedOptions = {
      specialization: document.getElementById("specialization-dropdown").textContent,
      priceRange: {
    ...
    <div className="container mx-auto mt-5 border-2 border-gray-200 rounded bg-purple-200">
      <div className="flex flex-col divide-black md:justify-around md:flex-row ">
        <div className="m-auto md:py-2">
          ...
          <Dropdown optionsList={learnOptions} id="specialization-dropdown"></Dropdown>
        </div>
        <div className="m-auto md:py-2">
